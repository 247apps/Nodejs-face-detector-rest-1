...
// test6, work, don't add exit()
    ...
    PImage.encodeJPEGToStream(img, fs.createWriteStream('./blurring-service/img/out8.jpg')).then(()=> { //encodePNGToStream
...
//process.exit()  //test, don't put here, it won't create image
//*/
...
//var img = new PImage2;
//img.src = "./blurring-service/img/sample_home_2face.png";
//
...
//    img = new PImage2;
//    img.src = "./blurring-service/img/sample_home_2faceOut.png";
//}
//end test5
